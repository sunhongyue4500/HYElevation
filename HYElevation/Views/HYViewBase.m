...
- (void)restrainViewPort:(CGFloat)offsetLeft top:(CGFloat)offsetTop right:(CGFloat)offsetRight bottom:(CGFloat)offsetBottom {
...
- (BOOL)isInBoundsX:(CGFloat)x {
    return ([self isInBoundsLeft:x] && [self isInBoundsRight:x]) ? YES : NO;
}

- (BOOL)isInBoundsY:(CGFloat)y {
    return ([self isInBoundsTop:y] &&[self isInBoundsBottom:y]) ? YES : NO;
}

- (BOOL)isInBoundsX:(CGFloat)x y:(CGFloat)y {
    return ([ self isInBoundsX:x] && [self isInBoundsY:y]) ? YES : NO;
}
